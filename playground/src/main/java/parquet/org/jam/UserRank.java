...
public class UserRank extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -3191185045973724047L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"UserRank\",\"namespace\":\"parquet.org.jam\",\"fields\":[{\"name\":\"userId\",\"type\":\"int\"},{\"name\":\"rank\",\"type\":\"int\"}]}");
   ...
   */
  public static parquet.org.jam.UserRank.Builder newBuilder() {
    return new parquet.org.jam.UserRank.Builder();
  }
   ...
   * @return A new UserRank RecordBuilder
   */
  public static parquet.org.jam.UserRank.Builder newBuilder(parquet.org.jam.UserRank.Builder other) {
    return new parquet.org.jam.UserRank.Builder(other);
  }
   ...
   * @return A new UserRank RecordBuilder
   */
  public static parquet.org.jam.UserRank.Builder newBuilder(parquet.org.jam.UserRank other) {
    return new parquet.org.jam.UserRank.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<UserRank>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(parquet.org.jam.UserRank.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(parquet.org.jam.UserRank other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.userId)) {
        this.userId = data().deepCopy(fields()[0].schema(), other.userId);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public parquet.org.jam.UserRank.Builder setUserId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public parquet.org.jam.UserRank.Builder clearUserId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public parquet.org.jam.UserRank.Builder setRank(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public parquet.org.jam.UserRank.Builder clearRank() {
